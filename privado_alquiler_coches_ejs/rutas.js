...
rutas.post("/insert", (req,res)=>{
    const {nombre_modelo, unidades_totales, personas, puertas, maletas, tipo, cambio, precioDia} = req.body;
    const insert = `INSERT INTO modelos (nombre_modelo, unidades_totales, personas, puertas, maletas, tipo, cambio, precioDia) VALUES ('${nombre_modelo}', '${unidades_totales}', '${personas}', '${puertas}', '${maletas}', '${tipo}' , '${cambio}', '${precioDia}')`;
